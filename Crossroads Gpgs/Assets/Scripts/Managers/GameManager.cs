...
public class GameManager : MonoBehaviour
{
    ...
    public void CheckForInternetConnection()
    {
        ...
        Invoke("CheckForInternetConnection", 15f);
    }
    public void Start()
    {
        LoadData();
    ...
    public void AddReward(int reward)
    {
        ...
        GuiManager.instance.ChangeScore(score.ToString());
    }
    ...
    {
        GuiManager.instance.ChangeTapToStart(true);
    ...
    */
    ...
    public void OnStartGame()
    {
        ...
        /*
        if (mode == GameMode.TRANSIT)
            google.AddAchievment(GPGSIds.achievement_welcome, 100.0f);
        */
        GuiManager.instance.ChangeTapToStart(false);
        GuiManager.instance.ChangeScoreActive(true);
        GuiManager.instance.ChangeScore(score.ToString());
        ...
        GuiManager.instance.ShowRestartAndContinue(true, true);
    ...
    public void OnEndGame(bool won)
    {
        ...
        GuiManager.instance.ChangeNewRecord(newRecord);
        ...
        spawner.enabled = false;
        controller.enabled = false;
        SoundManager.instance.PauseOnOff(true);
